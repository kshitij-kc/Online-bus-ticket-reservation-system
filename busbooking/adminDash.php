...
<body>
    ...
    <th>Delete</th>
		...
		while ($row = mysqli_fetch_array($sqldata, MYSQLI_ASSOC)) {
			...
			echo "</td><td>";
			$depature_time = $row['departure_time'];
			$dateTime = DateTime::createFromFormat('H:i:s.u', $depature_time);
			$formatted_departure_time = $dateTime->format('h:i A');
			echo $formatted_departure_time;
		?>
