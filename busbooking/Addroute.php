     ...
     $dep_time=$_POST['departure_time'];
       ...
       if($conn->connect_error)
          ...
          else
          {
              ...
              $stmt=$conn->prepare("INSERT INTO route(via_city,destination,bus_name,departure_date,departure_time) VALUES(?,?,?,?,?)");
              //table3 is the table name//

              $stmt->bind_param("sssss",$via_city,$destination,$bus_name,$dep_date, $dep_time);
